...
Mở trình duyệt tại `/dam/` trên cổng dev (mặc định in ra terminal). Ứng dụng nạp hình học mẫu **dầm 1**: **SL = 1**, cao độ **4200**, **1 nhịp** **L = 6500 mm**, **H = 500**, **B = 300**, **B1 = 150**, **dH = 0**; sàn **1 — Sàn hai bên**, **HSL = HSR = 120 mm**, **HL = HR = 0**; gối **Cột**, **B = 300**, **B1 = 150** (cân giữa), **H** để trống, tên trục **1 … 2**; lớp bảo vệ **25 mm**, bê tông **B25**, thép **CB400-V**; danh sách thép để trống — dùng **Thêm** trên từng tab thép để bố trí. Nút **Mới** cùng bộ mặc định này.
