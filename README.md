...
2. Khai báo thép chủ / bổ sung lớp trên và lớp dưới (Thêm / Sửa / Xóa).
   ...
   - Thép chủ **lớp trên / lớp dưới** dài hơn **11,7 m** được **cắt tự động khi xuất PDF** (không cần tick từng thanh). Chọn chiều dài nối **30D / 35D / 40D**. Đầu nối đặt trong vùng M- gối **l₀/4**. PDF tách **1a / 1b / 1c** kèm DIM chiều dài và đầu nối.
