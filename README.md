...
Mở trình duyệt tại `/dam/` trên cổng dev (mặc định in ra terminal). Ứng dụng nạp hình học mẫu **dầm D1**: **SL = 1**, cao độ **4.2 m**, **1 nhịp** **L = 6500 mm**, **H = 500**, **B = 200**, **B1 = 100**, **dH = 0**; sàn **1 — Sàn hai bên**, **HSL = HSR = 120 mm**, **HL = HR = 0**; gối **Cột**, **B = 200**, **B1 = 100** (cân giữa), **H** để trống, tên trục **1 … 2**; lớp bảo vệ **25 mm**, bê tông **B25**, thép **CB400-V**; danh sách thép để trống — dùng **Thêm** trên từng tab thép để bố trí. Nút **Mới** cùng bộ mặc định này.
...
2. Khai báo thép chủ / bổ sung lớp trên và lớp dưới (Thêm / Sửa / Xóa).
   ...
   - Thép chủ **lớp trên**: form mặc định **2Ø18**, vị trí **1 → trục cuối**, **cắt thép tự động** nối **30D** (nối chỉ ngoài l₀/4). Danh sách trống đến khi bấm **Thêm**.
   - Thép chủ **lớp dưới**: form mặc định **2Ø18**, vị trí **1 → trục cuối**, **không móc**, **cắt thép tự động** nối **30D**. Tick **Có móc 2 đầu** rồi nhập **chiều cao móc (mm)** nếu cần móc đứng hai đầu thanh (mặc định max(20d, 400) khi mới tick).
...
3. Khai báo **thép đai**: mặc định **Ø8**, bố trí **1/4**, **A1 = 100 mm**, **A2 = 200 mm**. Chọn **Đai điều** nếu cần một khoảng trên cả nhịp. Với 1/4, chiều dài vùng gối **tự bằng thép tăng cường M-** (không có thì l₀/4).
   - **Thép bổ sung** (shop thép cột): **Đai C** khi một lớp thép chủ có số thanh lẻ, hoặc khi tick thép chống phình. **Đai lồng** / **Đai kép** chỉ hiện khi một lớp thép chủ ≥ 4 thanh. **Đai kép thay đai đơn** — không vẽ / không thống kê đai đơn; cạnh ngắn theo B = 2/3 đai đơn, ôm ngoài thép chủ được ôm. Lồng và kép loại trừ nhau. Mỗi loại chọn Ø6 / 8 / 10 / 12 / 14. **Thép chống phình** vẽ trên mặt dầm và shop nổ (2Ø); **vị trí bắt đầu / kết thúc** như thép chủ (mặc định **1 → trục cuối**). **Gối 1:** đầu thanh từ **da bê tông** thụt **50 mm**. **Hết dầm** (ôm tới gối cuối): điểm cuối cũng từ da gối thụt **50 mm**. Gối giữa vẫn **tim trục**. **Cắt tự động 30D** khi L > 11,7 m: lần lượt thanh **11700 mm**, đoạn còn lại là cây cuối — **không né gối / giữa nhịp**, không hiện tick cắt trên form. Hàng **CP nằm giữa M− và M+**. Cắt 11,7 m: shop nổ và thống kê tách theo **kích thước** — cùng L thì cùng số hiệu (**Xa** cho mọi cây 11700, **Xb** cho đoạn còn lại khác L). DIM đoạn nối **30D**. Mặt dầm chỉ số hiệu gốc. Mặt cắt: số hiệu đai đơn ở **2/3 H**, chống phình giữa H; đai C ghi **số hiệu** (Cx móc chống phình / Cy đứng), không ghi chữ C. Dưới **TL: 1/25** không còn khối chú thích.
...
Dữ liệu được lưu tự động trên trình duyệt (localStorage). **Save As** mở hộp thoại chọn nơi lưu (tên mặc định `[Giahuy.net]-shop_dam.json`); **Open** mở lại file đó để sửa. Dùng Chrome hoặc Edge để hiện hộp thoại. **Mới** khôi phục bộ số liệu mặc định (tên **D1**, SL = 1, 1 nhịp L = 6500).
