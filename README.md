...
2. Khai báo thép chủ / bổ sung lớp trên và lớp dưới (Thêm / Sửa / Xóa).
   - Thép bổ sung **lớp trên**, dạng 1: cắt thẳng cách mép cột **L/8** nhịp kề.
   - Thép bổ sung **lớp dưới**, dạng 1 (**M+ giữa nhịp**): chiều dài `l₀/2 + 2·max(h₀, 15d, l₀/16)` — đặt giữa nhịp, cắt cách mép trong gối `l₀/4 − max(h₀, 15d, l₀/16)`.
